...
public class MyImageTest extends ImageTest {
  ...
  public void testCompressTri() {
    MyImage result = triImage.compress(instance, 0);
    ...
    result = triImage.compress(instance, 0.5f);
    ...
    result = triImage.compress(instance, 1);
    expected = "RED:0 GREEN:0 BLUE:0    RED:0 GREEN:0 BLUE:0    \n"
               + "RED:0 GREEN:0 BLUE:0    RED:0 GREEN:0 BLUE:0    \n"
               + "RED:0 GREEN:0 BLUE:0    RED:0 GREEN:0 BLUE:0    \n";
    assertEquals(expected, result.toString());
  ...
  public void testCompressBlack() {
    ...
    assertEquals(expected, result.toString());
    result = blackImage.compress(instance, 0.5f);
    assertEquals(expected, result.toString());
