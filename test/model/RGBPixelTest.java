...
public class RGBPixelTest {
  ...
  public void setUp() throws Exception {
    ...
    allTestPixels=new RGBPixel[]{whitePixel,blackPixel,redPixel,greenPixel,bluePixel,brownPixel,
        purplePixel,yellowPixel,threeColorSamePixel,threeColorRedMaxPixel,threeColorGreenMaxPixel
  ...
  public void linearTransformation() {
    ...
    for(RGBPixel testPixel:allTestPixels){
      ...
      assertEquals(Math.round(0.3*testPixel.getRed()+0.2*testPixel.getGreen()+0.1*testPixel.getBlue()),
          result.getBlue());
    }
  }
