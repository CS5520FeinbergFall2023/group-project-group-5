...
public class RGBPixel implements Pixel {
   ...
   * larger than 2^BIT_DEPTH-1, the corresponding channel will be automatically set to
   * 2^BIT_DEPTH-1; if the input is  smaller than 0, the corresponding channel will be automatically
   * set to 0
   *
